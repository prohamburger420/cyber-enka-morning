...
LEAD_IN = {"talk1": 5.0}
# ★★2026-09-10 nordw耳判定「BGMが鳴ってから喋り初めまでが少し急。3〜5秒待とうか」
#   → 1.8 → **3.0**（4案 1.8/3.0/4.0/5.0 から nordw が3.0を選択）。talk1(5.0)以外の**全コーナー**に効く（交通・SA・ニュース・おたより・占い・ED）。
#   ⚠ ここを上げるとブロックが1本あたり1.2秒伸びる。7ブロックで約7秒。
#     伸びるのは**放送の尺**であって生成時間ではないので、おたよりの締切には影響しない。
DEFAULT_LEAD_IN = 3.0
